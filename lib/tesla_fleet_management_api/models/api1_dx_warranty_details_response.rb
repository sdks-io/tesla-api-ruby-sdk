...
module TeslaFleetManagementApi
  # Api1DxWarrantyDetailsResponse Model.
  class Api1DxWarrantyDetailsResponse < BaseModel
    SKIP = Object.new
    private_constant :SKIP

    # TODO: Write general description for this method
    # @return [ResponseApi1DxWarrantyDetailsResponse]
    ...
    def self.from_hash(hash)
      ...
      response = ResponseApi1DxWarrantyDetailsResponse.from_hash(hash['response']) if
        hash['response']
      ...
      Api1DxWarrantyDetailsResponse.new(response: response,
                                        additional_properties: additional_properties)
    end
