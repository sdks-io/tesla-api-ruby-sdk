...
module TeslaFleetManagementApi
  # RegisterPartnerResponse Model.
  class RegisterPartnerResponse < BaseModel
    SKIP = Object.new
    private_constant :SKIP

    # TODO: Write general description for this method
    # @return [ResponseRegisterPartnerResponse]
    ...
    def self.from_hash(hash)
      ...
      response = ResponseRegisterPartnerResponse.from_hash(hash['response']) if hash['response']
      ...
      RegisterPartnerResponse.new(response: response,
                                  additional_properties: additional_properties)
    end
