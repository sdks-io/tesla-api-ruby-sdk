...
module TeslaFleetManagementApi
  # Api1DxVehiclesOptionsResponse Model.
  class Api1DxVehiclesOptionsResponse < BaseModel
    SKIP = Object.new
    private_constant :SKIP

    # TODO: Write general description for this method
    # @return [ResponseApi1DxVehiclesOptionsResponse]
    ...
    def self.from_hash(hash)
      ...
      response = ResponseApi1DxVehiclesOptionsResponse.from_hash(hash['response']) if
        hash['response']
      ...
      Api1DxVehiclesOptionsResponse.new(response: response,
                                        additional_properties: additional_properties)
    end
